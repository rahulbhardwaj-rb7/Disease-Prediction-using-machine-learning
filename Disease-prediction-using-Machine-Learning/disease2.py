...
title_lbl.place(x=200, y=10, width=1000, height=100)

main_frame = Frame(root, bd=2, bg="lightgreen")
main_frame.place(x=200, y=100, width=1000, height=600)

img = Image.open("./images/bgg.jpeg")
